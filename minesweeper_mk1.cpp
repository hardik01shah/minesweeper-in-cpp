//MINESWEEPER_V1.0
//Editted 18/03/2020 by huntsman01
...
int A[8][8]={{1,2,2,2,1,0,0,0},{-1,3,-1,-1,1,0,0,0},{3,-1,3,2,1,0,0,0},{-1,2,1,1,1,1,0,0},{1,2,1,2,-1,1,0,0},{0,2,-1,3,1,2,1,1},{1,3,-1,2,0,1,-1,1},{1,-1,2,1,0,1,1,1}};
int B[8][8];
